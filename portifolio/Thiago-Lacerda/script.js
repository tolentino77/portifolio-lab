...
const translations = {
    pt: {
        ...
        jobDescription: "Gerenciamento de escritórios de advocacia, construindo softwares de gestão de prazos, clientes, além de automatizar todas as operações de escritórios de advocacia, como atendimento aos clientes, peticionamento e geração de peças",
        contactTitle: "Vamos Conversar?",
        contactDescription: "Estou sempre aberto a novos desafios e oportunidades de colaboração.",
        experienceDatee: "02/2025",
        jobTitlee: "Estagiário Logística",
        companyy: "Fundação Dom Cabral",
        jobDescriptionn: "Atualmente estagio na Fundação Dom Cabral, onde faço estudos de logística e produzo relatórios e gráficos sobre a logística no Brasil, faço análise de dados e trabalho com o banco de dados",
        contactTitle: "Vamos Conversar?",
        contactDescription: "Estou sempre aberto a novos desafios e oportunidades de colaboração.",
