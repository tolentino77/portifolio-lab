...
const translations = {
    pt: {
        ...
        about: "Sobre",
        contact: "Contato",
        aboutTitle: "Olá, eu sou o Victhor Ribeiro",
        aboutSubtitle: "Sou estudante de Engenharia de Software na PUC Minas",
        aboutText: "Atuo como Analista Desenvolvedor de Sistemas, com experiência no desenvolvimento de chatbots utilizando Blip e Microsoft LUIS, além de integração via APIs com JavaScript. Atualmente, sou especializado em soluções na plataforma Salesforce, focando na automação de processos nas áreas de Vendas e Marketing, incluindo integração com HubSpot, criação de painéis, regras de validação e fluxos automatizados.",
        ...
        contactDescription: "Estou sempre aberto a novos desafios.",
    ...
    en: {
        ...
        about: "About",
        contact: "Contact",
        aboutTitle: "Hi, I'm Victhor Ribeiro",
        aboutSubtitle: "I'm a Software Engineering Student on PUC Minas",
        aboutText: "I work as a Systems Developer Analyst, with experience developing chatbots using Blip and Microsoft LUIS, as well as API integration with JavaScript. Currently, I specialize in Salesforce solutions, focusing on process automation in the Sales and Marketing areas, including integration with HubSpot, dashboard creation, validation rules, and automated workflows.",
        ...
        contactDescription: "I'm always open to new challenges.",
